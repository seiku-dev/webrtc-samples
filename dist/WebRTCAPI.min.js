...
function createVConsole() {
    console.error('createVConsole')
    var scriptEle = document.createElement("script");
    scriptEle.src = 'https://sqimg.qq.com/expert_qq/vConsole/vconsole.min.js';
...
function WebRTCAPI( config , succ , fail ){
    ...
    console.error('isMobile.any', isMobile.any)
...
WebRTCAPI.fn.updateConstraints = function(videoCtrlAbility , ext) {
    ...
    if( ext && ext.video && ext.video.deviceId){
        ...
        //safari / ios 的兼容问题
        if( /* Browser.client.type === 'safari' && Browser.client.isIPhone */ isMobile.any ){
...
WebRTCAPI.fn.chooseVideoDevice = function( video ) {
    ...
    console.error('chooseVideoDevice , global.localStream', global.localStream)
    if( global.localStream ){
...
MediaUtil.fn.gum = function( opts, succ, fail ){
    ...
    console.error('constraints',opts.constraints)
