...
var BJ_WEBRTC = __webpack_require__(38);
...
Report.fn.getQualityReportFronSafariAsync = function (peerconnections, callback) {
    var global = this.global;
...
Report.fn.quality = function () {
    ...
    if (!DetectRTC.isSafari()) {
        ...
        this.getQualityReportFronSafariAsync(global.peerConnections, function (result, data) {
            var sendData = self.createJsonFromTag(Constants.RTC_EVENT.ON_QUALITY_REPORT);
...
(function(){
    ...
    window.getUserMedia = (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) || navigator.getUserMedia
...
var MediaUtil = __webpack_require__(39)
var Log = __webpack_require__(3)
var DetectRTC = __webpack_require__(9)
var WebSocketClient = __webpack_require__(40)
var StreamHandler = __webpack_require__(41)
var Browser = __webpack_require__(42)
var Emitter = __webpack_require__(43)
var mitt = __webpack_require__(44)
var _ = __webpack_require__(45)
var jparam = __webpack_require__(47);
var SoundMeter = __webpack_require__(48)
var isMobile = __webpack_require__(49)
WebRTCStat.init();
    ...
    var initWebSocket = function() {
        try {
            ...
            jparam({
                ...
                privMapEncrypt: global.config.privMapEncrypt,
    ...
    //     }
        try {
            navigator.mediaDevices.enumerateDevices().then(function (devices) {
                ...
                var msg = "WEBRTC--enumeadevice failed!!! failed = " + e.message;
                Log.uploadWebLog(global, msg, null, "ENUM_DEVICE");
                global.deviceInfo.hasVideo = true;
                global.deviceInfo.hasAudio = true;
                $self.emitter.emit("onErrorNotify",{
 ...
 */
var BJ_WEBRTC = (function(global) {
    if (global.BJ_WEBRTC) return global.BJ_WEBRTC;
    ...
    global.onerror = function(msg, url, line, col, error) {
        ...
        if (_config.jsErrorMSID) {
            data.ext = {
                msid: _config.jsErrorMSID,
            };
        }
        report.push(data);
    ...
    var _error_tostring = function(error, index) {
        ...
        if (_isOBJ(error)) {
            ...
            if (!error.ext) {
                ...
                switch(error.level) {
                    case 1:
                        monitorId = _config.debugMSID;
                        break;
                    case 2:
                        monitorId = _config.infoMSID;
                        break;
                    case 4:
                        monitorId = _config.errorMSID;
                        break;
                    default:
                        break;
                }
                ...
                if (!_isEmpty(value)) {
                    if (_isOBJ(value)) {
                        try {
                            ...
                            value = "[BJ_WEBRTC detect value stringify error] " + err.toString();
                        }
                    }
    ...
    var _send = function(isReoprtNow) {
        ...
        while (_error.length) {
            ...
            if (!isIgnore) {
                if(error.id && error.id.toString() !== _config.id.toString()) { // 临时修改id上报
                    var reportUrl = (_config.url || "/badjs") +
                    "?uin=" + _config.uin +
                    "&from=" + encodeURIComponent(location.href) +
                    "&";
                    _submit(reportUrl + error_str[2] + "&_t=" + (+new Date));
                } else if (_config.combo) {
    ...
    var _wrapMsg = function(msg, level) {
        var result = msg;
        if (_isOBJ(msg)) {
            result.level = level;
        } else {
    ...
    var report = {
        ...
        error: function(msg) { // error report
            if (!msg) {
                return report;
            }
            msg = _wrapMsg(msg, 4);
...
if (true) {
    if (typeof module !== "undefined" && module.exports) {
        exports = module.exports = BJ_WEBRTC;
    }
    exports.BJ_WEBRTC = BJ_WEBRTC;
}
...
MediaUtil.fn.gum = function( opts, succ, fail ){
    ...
    getUserMedia( opts.constraints ).then(function (stream) {
        if( succ ){
...
MediaUtil.fn.gumByScreen = function(opts, succ, fail){
    ...
    //获取屏幕分享
    var promises = [ Promise.resolve( getUserMedia(_.extend({},screen_constraints,{audio:false})) ) ];
    //根据配置决定是否获取麦克风
    if( screen_constraints.audio){
        ...
        promises.push( Promise.resolve( getUserMedia( constraint ) ) )
    }
...
MediaUtil.fn.packConstraints = function( constraints, opts, ext){
    ...
    if( opts && opts.attributes ){
        new_constraints = {
            audio: typeof opts.audio !== 'undefined' ? opts.video : true,
