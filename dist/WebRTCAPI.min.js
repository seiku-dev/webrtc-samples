...
var Report = __webpack_require__(33)
var MediaUtil = __webpack_require__(38)
var Log = __webpack_require__(30)
var DetectRTC = __webpack_require__(32)
...
WebRTCAPI.fn.connect = function( succ , fail ){
    ...
    global.config.accountType = config.accountType || 0;
    global.config.closeLocalMedia = config.closeLocalMedia || false;
        ...
        if (videoCtrlAbility.length > 0) {
            ...
            if( Constants.ConstraintsMode === 1 ){
                ...
                if (VidWidth > 0 && VidHeight > 0 && VidFr > 0) {
                    ...
                    if( VidFr ){
                        mandatory.maxFrameRate = VidFr;
                        mandatory.minFrameRate = VidFr;
                    }
...
/* WEBPACK VAR INJECTION */(function(global) {var Constants = __webpack_require__(29)
var DetectRTC = __webpack_require__(32)
var Util = __webpack_require__(31)
var Log = __webpack_require__(30)
...
MediaUtil.fn.gum = function( opts, succ, fail ){
    ...
    navigator.mediaDevices.getUserMedia( opts.constraints ).then(function (stream) {
        ...
        if (self.hasRetryOpenCamera || error.name ==='NotFoundError' || error.name === 'NotSupportedError') {
            if( global ){
...
/* WEBPACK VAR INJECTION */(function(global) {var Log = __webpack_require__(30)
var Constants = __webpack_require__(29)
