...
function getAudio() {
  getMediaStream('audio', function(stream) {
    document.getElementById("pureAudio").srcObject = stream
    document.getElementById("pureAudio").controls = true
  })
}
function push() {
  //推流
